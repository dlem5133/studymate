<template>
    <div style="margin-top:6rem;" class="container">
        <div class="container">
            <h4 style="font-family:'Do Hyeon',sans-serif;">RANK <i class="fas fa-medal"></i></h4>
            <div class="d-flex mx-4 my-5 justify-content-center">

                <div class="card mx-2 my-auto" style="position:relative;width:14rem;box-shadow:0px 0px 5px #C0C0C0;">
                    <div class="cardprofile">
                        <div style="margin:0.4rem;" v-if="!RankData1[1].user.profile_image">
                            ...
                            /><i style="color:#C0C0C0;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <div style="margin:0.4rem;" v-else>
                            <img
                                class="profileimg rounded-circle border"
                                :src="RankData1[1].user.profile_image"
                            /><i style="color:#C0C0C0;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <p style="font-family:'Do Hyeon',sans-serif;">{{RankData1[1].user.nickname}}</p>
                        <p style="font-size:1.2rem;color:orange;font-family:'Do Hyeon',sans-serif;">{{RankData1[1].total}}점</p>
                    </div>
                    <div class="mileage w-100">
                        <div class="row border-top w-100" style="background-color:rgba(255,165,0,0.2);margin:0;">
                ...
                <div class="card border-0 mx-2 my-auto" style="position:relative;width:14rem;box-shadow:0px 0px 5px gold;">
                    <div class="cardprofile">
                        <div style="margin:0.4rem;" v-if="!RankData1[0].user.profile_image">
                            <img
                                class="profileimg rounded-circle border"
                                src="../../assets/img/defualt_image.png"
                            /><i style="color:gold;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <div style="margin:0.4rem;" v-else>
                            <img
                                class="profileimg rounded-circle border"
                                :src="RankData1[0].user.profile_image"
                            /><i style="color:gold;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <p style="font-family:'Do Hyeon',sans-serif;">{{RankData1[0].user.nickname}}</p>
                        <p style="font-size:1.2rem;color:orange;font-family:'Do Hyeon',sans-serif;">{{RankData1[0].total}}점</p>
                    </div>
                    <div class="mileage w-100">
                        <div class="row border-top w-100" style="background-color:rgba(255,165,0,0.2);margin:0;">
                            <div class="col p-1 border-right">
                ...
                <div class="card border-0 mx-2 my-auto" style="position:relative;width:14rem;box-shadow:0px 0px 5px #cd7f32;">
                    <div class="cardprofile">
                        <div style="margin:0.4rem;" v-if="!RankData1[2].user.profile_image">
                            <img
                                class="profileimg rounded-circle border"
                                src="../../assets/img/defualt_image.png"
                            /><i style="color: #cd7f32;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <div style="margin:0.4rem;" v-else>
                            <img
                                class="profileimg rounded-circle border"
                                :src="RankData1[2].user.profile_image"
                            /><i style="color: #cd7f32;position:absolute;top:2%;left:2%;font-size:1.5rem;text-shadow: 2px 2px 4px gray;" class="fas fa-trophy"></i>
                        </div>
                        <p style="font-family:'Do Hyeon',sans-serif;">{{RankData1[2].user.nickname}}</p>
                        <p style="font-size:1.2rem;color:orange;font-family:'Do Hyeon',sans-serif;">{{RankData1[2].total}}점</p>
                    </div>
                    <div class="mileage w-100">
                        <div class="row border-top w-100" style="background-color:rgba(255,165,0,0.2);margin:0;">
                            <div class="col p-1 border-right">
