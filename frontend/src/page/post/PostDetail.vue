  ...
  <div class="detail container">
    ...
    <div class="col-12 col-sm-12 col-md-12">
      ...
      <div class="d-flex align-items-end flex-column bd-highlight mb-3">
        ...
        <b-badge variant="success" class="ml-1" size="sm" v-if="postData.tmp==0">진행중</b-badge>
      </div>
    </div>
    <hr />
    ...
    <div class="card shadow mb-5">
      ...
      <div class="p-3 pb-4">
        ...
        <p
          v-else
          class="align-self-center m-1 text-left font-weight-bold"
        >{{replyparent}}'s Comments</p>
        <div class="d-flex inline">
          <textarea type="text" v-model="newReply.reply_content" id="content" class="border w-100" />
          <b-button class="ml-3" variant="outline-secondary" @click="replyCreate(replyparent)">작성</b-button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    changeLike() {
      if (this.islike) { return "heart-fill"; }
      else { return "heart"; }
    },
  },
  mounted() {
